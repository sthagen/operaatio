#! /usr/bin/env bash
# Deploy btop as compiled from a public proxy repository for system wide use
tool="btop"
binary="${tool}"
server_url="https://github.com"
provider_org="sthagen"
repo_dir="aristocratos-${tool}"
...
STATIC=true PREFIX="${prefix}" make && STATIC=true PREFIX="${prefix}" make install
